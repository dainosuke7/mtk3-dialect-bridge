...
C_SRCS += \
../Application/npu/st/device/mcu_cache.c 

OBJS += \
./Application/npu/st/device/mcu_cache.o 

C_DEPS += \
./Application/npu/st/device/mcu_cache.d 


# Each subdirectory must supply rules for building sources it contributes
Application/npu/st/device/%.o Application/npu/st/device/%.su Application/npu/st/device/%.cyclo: ../Application/npu/st/device/%.c Application/npu/st/device/subdir.mk
...
clean: clean-Application-2f-npu-2f-st-2f-device

clean-Application-2f-npu-2f-st-2f-device:
	-$(RM) ./Application/npu/st/device/mcu_cache.cyclo ./Application/npu/st/device/mcu_cache.d ./Application/npu/st/device/mcu_cache.o ./Application/npu/st/device/mcu_cache.su

.PHONY: clean-Application-2f-npu-2f-st-2f-device
