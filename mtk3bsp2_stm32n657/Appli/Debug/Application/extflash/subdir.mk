...
C_SRCS += \
../Application/extflash/extflash.c 

OBJS += \
./Application/extflash/extflash.o 

C_DEPS += \
./Application/extflash/extflash.d 


# Each subdirectory must supply rules for building sources it contributes
Application/extflash/%.o Application/extflash/%.su Application/extflash/%.cyclo: ../Application/extflash/%.c Application/extflash/subdir.mk
...
clean: clean-Application-2f-extflash

clean-Application-2f-extflash:
	-$(RM) ./Application/extflash/extflash.cyclo ./Application/extflash/extflash.d ./Application/extflash/extflash.o ./Application/extflash/extflash.su

.PHONY: clean-Application-2f-extflash
